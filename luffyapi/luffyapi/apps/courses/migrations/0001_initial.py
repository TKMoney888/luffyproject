    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updateed_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('number', models.SmallIntegerField(default=1, verbose_name='章节序号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.CharField(blank=True, help_text='导师标签签名', max_length=255, null=True, verbose_name='导师标签签名')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='courses.CourseCategory', verbose_name='课程分类'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',

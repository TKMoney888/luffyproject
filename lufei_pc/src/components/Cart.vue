      ...
      <div class="cart_info">
        ...
        <div class="cart_table">
          ...
          <div class="cart_course_list">
            <CartItem :key="key" v-for="course,key in course_list" :course="course" @del_cart="del_course(key)" @select_cart="select_course(key)"></CartItem>
          </div>
          <div class="cart_footer_row">
            ...
            <span class="cart_total">总计：¥{{cart_total_price}}</span>
          </div>
        </div>
      </div>
      <Footer></Footer>
...
export default {
    ...
    methods:{
      ...
      cart_total(){
        ...
        this.cart_total_price = total.toFixed(2);
      },
      select_course(key){
        // 切换不同价格选项，重新汇算新的总价格
        this.cart_total();
